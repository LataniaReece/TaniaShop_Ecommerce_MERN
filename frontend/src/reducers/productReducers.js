...
export const productsRecentListReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        case PRODUCT_RECENT_LIST_REQUEST:
            return { loading: true, products: [] }
        case PRODUCT_RECENT_LIST_SUCCESS:
            return {
                loading: false,
                products: action.payload.products,
                pages: action.payload.pages,
...
export const productsListByCategoryReducer = (state = { products: [] }, action) => {
    switch (action.type) {
